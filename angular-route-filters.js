...
(function (RouteFilters) {
    var Route = (function () {
         ...
         * @param definition
         */
        Route.prototype.beforeFilter = function (name, definition) {
            this._beforeFilters[name] =
                new RouteFilters.BeforeFilter(name, this._$injector.invoke(definition));
        };
         ...
         *
         */
        Route.prototype.finishResolution = function () {
         ...
         * @returns {boolean}
         */
        Route.prototype.hasResolutionStarted = function () {
